...
/**
 * @brief private clock configuration function
 * @retval None
 * @param None
 */
void Clk_Config(void){
...
void Dac_Config(void){
	...
	DAC->CR |= (0x01);				      //DAC CH1 ENABLE
	DAC->SWTRIGR |= (0x00000000);		  //software trigger disable for (ch1,ch2)
	DAC->DHR12R1 |= (0x00000000); 		  //set initial output value of ch1
